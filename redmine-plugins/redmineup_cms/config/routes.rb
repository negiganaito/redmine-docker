...
match 'auto_completes/cms_pages' => 'auto_completes#cms_pages', :via => :get, :as => 'auto_complete_cms_pages'
match 'auto_completes/cms_snippet_tags' => 'auto_completes#cms_snippet_tags', :via => :get, :as => 'auto_complete_cms_snippet_tags'
