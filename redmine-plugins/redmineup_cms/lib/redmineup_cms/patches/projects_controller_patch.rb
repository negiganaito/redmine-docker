    ...
    module ProjectsControllerPatch
      ...
      module InstanceMethods
        def show_with_cms
          ...
          unless !User.current.allowed_to?(:view_project_tabs, @project) || (page_path = RedmineupCms.get_project_settings('landing_page', @project.id)).blank?
            if page_path == "last"
...
unless ProjectsController.included_modules.include?(RedmineupCms::Patches::ProjectsControllerPatch)
  ProjectsController.send(:include, RedmineupCms::Patches::ProjectsControllerPatch)
end
