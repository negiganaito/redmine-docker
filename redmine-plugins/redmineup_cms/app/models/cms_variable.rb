...
class CmsVariable
  ...
  def self.all
    cms_variables = Setting.plugin_redmineup_cms["cms_variables"].is_a?(Hash) ? Setting.plugin_redmineup_cms['cms_variables'] : {}
  ...
  def save
    ...
    Setting.plugin_redmineup_cms = Setting.plugin_redmineup_cms.merge('cms_variables' => cms_variables)
  end
