...
class CmsPageQuery < Query
  ...
  def initialize_available_filters
    ...
    status_values = [[l(:label_cms_status_locked), RedmineupCms::STATUS_LOCKED.to_s], [l(:label_cms_status_active), RedmineupCms::STATUS_ACTIVE.to_s]]
    ...
    add_available_filter('is_cached', :type => :list, 
                                      :values => [[l(:general_text_Yes), '1'], [l(:general_text_No), '0']],
                                      :name => l(:label_cms_is_cached))
