...
class CmsRedmineLayout
  ...
  def self.all
    redmine_layouts = Setting.plugin_redmineup_cms['redmine_layouts'].is_a?(Hash) ? Setting.plugin_redmineup_cms['redmine_layouts'] : {}
  ...
  def save
    ...
    Setting.plugin_redmineup_cms = Setting.plugin_redmineup_cms.merge('redmine_layouts' => redmine_layouts)
  end
