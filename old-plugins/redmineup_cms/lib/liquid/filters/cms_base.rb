    ...
    module Filters
      module CmsBase
        ...
        def get_attachment_drop(input)
          ...
          return input if input.is_a?(::Redmineup::CmsAttachmentDrop)
          ...
          ::Redmineup::CmsAttachmentDrop.new attachment
        end
        ...
        def get_part_drop(input)
          return if input.blank?
          return input if input.is_a?(::Redmineup::PartDrop)
          ...
          ::Redmineup::PartDrop.new part
        end

        def get_page_drop(input)
          return if input.blank?
          return input if input.is_a?(::Redmineup::PageDrop)
          page = CmsPage.where(:name => input).first
          return if page.blank?
          ::Redmineup::PageDrop.new page
        end
      ...
      ::Liquid::Template.register_filter(RedmineupCms::Liquid::Filters::CmsBase)
    end
  end
end
