...
unless ProjectsHelper.included_modules.include?(RedmineupCms::Patches::ProjectsHelperPatch)
  ProjectsHelper.send(:include, RedmineupCms::Patches::ProjectsHelperPatch)
end
