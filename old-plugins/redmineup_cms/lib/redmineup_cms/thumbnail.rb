...
module RedmineupCms
  module Thumbnail
      ...
      if attachment.thumbnailable? && attachment.readable?
        ...
        begin
          ...
          unless File.exists?(target)
            ...
            unless File.open(attachment.diskfile) { |f| Redmine::Thumbnail::ALLOWED_TYPES.include? image_type_for(f) }
              return nil
            end
    ...
    def self.image_type_for(file)
      return Marcel::MimeType.for(file) if Redmine::VERSION.to_s > "4.1"
